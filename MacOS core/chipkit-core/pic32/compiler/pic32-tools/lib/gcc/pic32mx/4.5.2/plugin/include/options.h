...
extern int TARGET_MCHP_MIPS16E;
...
struct GTY(()) cl_optimization
{
  ...
  signed char flag_use_caller_save;
...
#define MASK_FUSED_MADD (1 << 12)
#define MASK_MIPS16 (1 << 13)
#define MASK_LLSC (1 << 14)
#define MASK_LONG64 (1 << 15)
#define MASK_MCU (1 << 16)
#define MASK_MEMCPY (1 << 17)
#define MASK_MICROMIPS (1 << 18)
#define MASK_RELAX_PIC_CALLS (1 << 19)
#define MASK_SOFT_FLOAT_ABI (1 << 20)
#define MASK_SPLIT_ADDRESSES (1 << 21)
#define MASK_SYNCI (1 << 22)
...
enum opt_code
{
  ...
  OPT_fframe_base_loclist,                   /* -fframe-base-loclist */
  ...
  OPT_finstrument_function_calls,            /* -finstrument-function-calls */
  ...
  OPT_fuse_caller_save,                      /* -fuse-caller-save */
  ...
  OPT_mconfig_data_dir_,                     /* -mconfig-data-dir= */
  OPT_mdebugdmips,                           /* -mdebugdmips */
  OPT_mdebugger,                             /* -mdebugger */
  OPT_mdebugmips,                            /* -mdebugmips */
  ...
  OPT_mframe_header_opt,                     /* -mframe-header-opt */
  OPT_mfused_madd,                           /* -mfused-madd */
  OPT_mgpopt,                                /* -mgpopt */
  OPT_minterlink_compressed,                 /* -minterlink-compressed */
  ...
  OPT_mmcu,                                  /* -mmcu */
  OPT_mmemcpy,                               /* -mmemcpy */
  OPT_mmicromips,                            /* -mmicromips */
  OPT_mmips_tfile,                           /* -mmips-tfile */
  OPT_mmips16_exceptions,                    /* -mmips16-exceptions */
  OPT_mmt,                                   /* -mmt */
  OPT_mno_default_isr_vectors,               /* -mno-default-isr-vectors */
  OPT_mno_dspr2,                             /* -mno-dspr2 */
  OPT_mno_float,                             /* -mno-float */
  OPT_mno_flush_func,                        /* -mno-flush-func */
  OPT_mno_mcu,                               /* -mno-mcu */
  OPT_mno_mips16,                            /* -mno-mips16 */
  OPT_mno_mpdebug_lib,                       /* -mno-mpdebug-lib */
  OPT_mperipheral_libs,                      /* -mperipheral-libs */
  OPT_mpic32mxlibs,                          /* -mpic32mxlibs */
  OPT_mpic32mzlibs,                          /* -mpic32mzlibs */
  OPT_mplt,                                  /* -mplt */
  OPT_mprint_builtins,                       /* -mprint-builtins */
  OPT_mprocessor_,                           /* -mprocessor= */
  OPT_mr10k_cache_barrier_,                  /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls,                      /* -mrelax-pic-calls */
  OPT_mresource_,                            /* -mresource= */
  OPT_mshared,                               /* -mshared */
  OPT_msmall_isa,                            /* -msmall-isa */
  OPT_msmart_io,                             /* -msmart-io */
  OPT_msmart_io_,                            /* -msmart-io= */
