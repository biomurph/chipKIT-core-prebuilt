...
#define ConfigIntCNC(config) (mCNCClearIntFlag(), mCNSetIntPriority(((config) & 7)),\
        mCNCIntEnable(((config) >> 23)))
#define ConfigIntCND(config) (mCNDClearIntFlag(), mCNSetIntPriority(((config) & 7)),\
        mCNDIntEnable(((config) >> 23)))
#define ConfigIntCNE(config) (mCNEClearIntFlag(), mCNSetIntPriority(((config) & 7)),\
        mCNEIntEnable(((config) >> 23)))
#define ConfigIntCNF(config) (mCNFClearIntFlag(), mCNSetIntPriority(((config) & 7)),\
        mCNFIntEnable(((config) >> 23)))
#define ConfigIntCNG(config) (mCNGClearIntFlag(), mCNSetIntPriority(((config) & 7)),\
        mCNGIntEnable(((config) >> 23)))
...
#define mCNCClose() (mCNCClearIntFlag(), mCNCIntEnable(0), CNCONCCLR = (1 << 15),\
                    CNENC = 0, CNPUC = 0)
#define mCNDClose() (mCNDClearIntFlag(), mCNDIntEnable(0), CNCONDCLR = (1 << 15),\
                    CNEND = 0, CNPUD = 0)
#define mCNEClose() (mCNEClearIntFlag(), mCNEIntEnable(0), CNCONECLR = (1 << 15),\
                    CNENE = 0, CNPUE = 0)
#define mCNFClose() (mCNFClearIntFlag(), mCNFIntEnable(0), CNCONFCLR = (1 << 15),\
                    CNENF = 0, CNPUF = 0)
#define mCNGClose() (mCNGClearIntFlag(), mCNGIntEnable(0), CNCONGCLR = (1 << 15),\
                    CNENG = 0, CNPUG = 0)
...
#elif ((__PIC32_FEATURE_SET__ == 330) || (__PIC32_FEATURE_SET__ == 350) || (__PIC32_FEATURE_SET__ == 370) || (__PIC32_FEATURE_SET__ == 430) || (__PIC32_FEATURE_SET__ == 450) || (__PIC32_FEATURE_SET__ == 470))
#define EnableCNA15                (CNENASET = (1 << _CNENA_CNIEA15_POSITION))
#define EnableCNA14                (CNENASET = (1 << _CNENA_CNIEA14_POSITION))
#define EnableCNA10                (CNENASET = (1 << _CNENA_CNIEA10_POSITION))
#define EnableCNA9                 (CNENASET = (1 << _CNENA_CNIEA9_POSITION))
#define EnableCNA7                 (CNENASET = (1 << _CNENA_CNIEA7_POSITION))
#define EnableCNA6                 (CNENASET = (1 << _CNENA_CNIEA6_POSITION))
#define EnableCNA5                 (CNENASET = (1 << _CNENA_CNIEA5_POSITION))
#define EnableCNA4                 (CNENASET = (1 << _CNENA_CNIEA4_POSITION))
#define EnableCNA3                 (CNENASET = (1 << _CNENA_CNIEA3_POSITION))
#define EnableCNA2                 (CNENASET = (1 << _CNENA_CNIEA2_POSITION))
#define EnableCNA1                 (CNENASET = (1 << _CNENA_CNIEA1_POSITION))
...
#define EnableCNC15                (CNENCSET = (1 << _CNENC_CNIEC15_POSITION))
#define EnableCNC14                (CNENCSET = (1 << _CNENC_CNIEC14_POSITION))
#define EnableCNC13                (CNENCSET = (1 << _CNENC_CNIEC13_POSITION))
#define EnableCNC12                (CNENCSET = (1 << _CNENC_CNIEC12_POSITION))
#define EnableCNC4                 (CNENCSET = (1 << _CNENC_CNIEC4_POSITION))
#define EnableCNC3                 (CNENCSET = (1 << _CNENC_CNIEC3_POSITION))
#define EnableCNC2                 (CNENCSET = (1 << _CNENC_CNIEC2_POSITION))
#define EnableCNC1                 (CNENCSET = (1 << _CNENC_CNIEC1_POSITION))

#define EnableCND15                (CNENDSET = (1 << _CNEND_CNIED15_POSITION))
#define EnableCND14                (CNENDSET = (1 << _CNEND_CNIED14_POSITION))
#define EnableCND13                (CNENDSET = (1 << _CNEND_CNIED13_POSITION))
#define EnableCND12                (CNENDSET = (1 << _CNEND_CNIED12_POSITION))
#define EnableCND11                (CNENDSET = (1 << _CNEND_CNIED11_POSITION))
#define EnableCND10                (CNENDSET = (1 << _CNEND_CNIED10_POSITION))
#define EnableCND9                 (CNENDSET = (1 << _CNEND_CNIED9_POSITION))
#define EnableCND8                 (CNENDSET = (1 << _CNEND_CNIED8_POSITION))
#define EnableCND7                 (CNENDSET = (1 << _CNEND_CNIED7_POSITION))
#define EnableCND6                 (CNENDSET = (1 << _CNEND_CNIED6_POSITION))
#define EnableCND5                 (CNENDSET = (1 << _CNEND_CNIED5_POSITION))
#define EnableCND4                 (CNENDSET = (1 << _CNEND_CNIED4_POSITION))
#define EnableCND3                 (CNENDSET = (1 << _CNEND_CNIED3_POSITION))
#define EnableCND2                 (CNENDSET = (1 << _CNEND_CNIED2_POSITION))
#define EnableCND1                 (CNENDSET = (1 << _CNEND_CNIED1_POSITION))
#define EnableCND0                 (CNENDSET = (1 << _CNEND_CNIED0_POSITION))

#define EnableCNE9                 (CNENESET = (1 << _CNENE_CNIEE9_POSITION))
#define EnableCNE8                 (CNENESET = (1 << _CNENE_CNIEE8_POSITION))
#define EnableCNE7                 (CNENESET = (1 << _CNENE_CNIEE7_POSITION))
#define EnableCNE6                 (CNENESET = (1 << _CNENE_CNIEE6_POSITION))
#define EnableCNE5                 (CNENESET = (1 << _CNENE_CNIEE5_POSITION))
#define EnableCNE4                 (CNENESET = (1 << _CNENE_CNIEE4_POSITION))
#define EnableCNE3                 (CNENESET = (1 << _CNENE_CNIEE3_POSITION))
#define EnableCNE2                 (CNENESET = (1 << _CNENE_CNIEE2_POSITION))
#define EnableCNE1                 (CNENESET = (1 << _CNENE_CNIEE1_POSITION))
#define EnableCNE0                 (CNENESET = (1 << _CNENE_CNIEE0_POSITION))

#define EnableCNF13                (CNENFSET = (1 << _CNENF_CNIEF13_POSITION))
#define EnableCNF12                (CNENFSET = (1 << _CNENF_CNIEF12_POSITION))
#define EnableCNF8                 (CNENFSET = (1 << _CNENF_CNIEF8_POSITION))
#define EnableCNF7                 (CNENFSET = (1 << _CNENF_CNIEF7_POSITION))
#define EnableCNF6                 (CNENFSET = (1 << _CNENF_CNIEF6_POSITION))
#define EnableCNF5                 (CNENFSET = (1 << _CNENF_CNIEF5_POSITION))
#define EnableCNF4                 (CNENFSET = (1 << _CNENF_CNIEF4_POSITION))
#define EnableCNF3                 (CNENFSET = (1 << _CNENF_CNIEF3_POSITION))
#define EnableCNF2                 (CNENFSET = (1 << _CNENF_CNIEF2_POSITION))
#define EnableCNF1                 (CNENFSET = (1 << _CNENF_CNIEF1_POSITION))
#define EnableCNF0                 (CNENFSET = (1 << _CNENF_CNIEF0_POSITION))

#define EnableCNG9                 (CNENGSET = (1 << _CNENG_CNIEG9_POSITION))
#define EnableCNG8                 (CNENGSET = (1 << _CNENG_CNIEG8_POSITION))
#define EnableCNG7                 (CNENGSET = (1 << _CNENG_CNIEG7_POSITION))
#define EnableCNG6                 (CNENGSET = (1 << _CNENG_CNIEG6_POSITION))
#define EnableCNG3                 (CNENGSET = (1 << _CNENG_CNIEG3_POSITION))
#define EnableCNG2                 (CNENGSET = (1 << _CNENG_CNIEG2_POSITION))
#define EnableCNG1                 (CNENGSET = (1 << _CNENG_CNIEG1_POSITION))
#define EnableCNG0                 (CNENGSET = (1 << _CNENG_CNIEG0_POSITION))
...
#if (((__PIC32_FEATURE_SET__ >= 100) && (__PIC32_FEATURE_SET__ <= 299)) || defined(__32MXGENERIC__))
	#define mPORTASetPinsAnalogOut(_outputs)    (TRISACLR = (unsigned int)(_outputs),\
...
#if (((__PIC32_FEATURE_SET__ >= 100) && (__PIC32_FEATURE_SET__ <= 299)) || defined(__32MXGENERIC__))
	#define mPORTBSetPinsAnalogOut(_outputs)    (TRISBCLR = (unsigned int)(_outputs),\
...
#if (((__PIC32_FEATURE_SET__ >= 100) && (__PIC32_FEATURE_SET__ <= 299)) || defined(__32MXGENERIC__))
	#define mPORTCSetPinsAnalogOut(_outputs)    (TRISCCLR = (unsigned int)(_outputs),\
...
#define mPORTDCloseBits(_bits)              (TRISDSET = (unsigned int)(_bits),\
        ...
        #define mPORTDSetPinsAnalogOut(_outputs)    (TRISDCLR = (unsigned int)(_outputs),\
												ANSELDSET = (unsigned int)(_outputs))
	#define mPORTDSetPinsAnalogIn(_inputs)      (TRISDSET = (unsigned int)(_inputs),\
												ANSELDSET = (unsigned int)(_inputs))
	#define mPORTDSetPinsDigitalOut(_outputs)   (TRISDCLR = (unsigned int)(_outputs),\
												ANSELDCLR = (unsigned int)(_outputs))
	#define mPORTDSetPinsDigitalIn(_inputs)     (TRISDSET = (unsigned int)(_inputs),\
												ANSELDCLR = (unsigned int)(_inputs))
#else
#define mPORTDSetPinsDigitalIn(_inputs)     (TRISDSET = (unsigned int)(_inputs))
#define mPORTDSetPinsDigitalOut(_outputs)   (TRISDCLR = (unsigned int)(_outputs))
...
#if ((__PIC32_FEATURE_SET__ == 330) || (__PIC32_FEATURE_SET__ == 350) || (__PIC32_FEATURE_SET__ == 370) || (__PIC32_FEATURE_SET__ == 430) || (__PIC32_FEATURE_SET__ == 450) || (__PIC32_FEATURE_SET__ == 470))
        #define mPORTESetPinsAnalogOut(_outputs)    (TRISECLR = (unsigned int)(_outputs),\
												ANSELESET = (unsigned int)(_outputs))
	#define mPORTESetPinsAnalogIn(_inputs)      (TRISESET = (unsigned int)(_inputs),\
												ANSELESET = (unsigned int)(_inputs))
	#define mPORTESetPinsDigitalOut(_outputs)   (TRISECLR = (unsigned int)(_outputs),\
												ANSELECLR = (unsigned int)(_outputs))
	#define mPORTESetPinsDigitalIn(_inputs)     (TRISESET = (unsigned int)(_inputs),\
												ANSELECLR = (unsigned int)(_inputs))
#else
#define mPORTESetPinsDigitalIn(_inputs)     (TRISESET = (unsigned int)(_inputs))
#define mPORTESetPinsDigitalOut(_outputs)   (TRISECLR = (unsigned int)(_outputs))
...
#if ((__PIC32_FEATURE_SET__ == 330) || (__PIC32_FEATURE_SET__ == 350) || (__PIC32_FEATURE_SET__ == 370) || (__PIC32_FEATURE_SET__ == 430) || (__PIC32_FEATURE_SET__ == 450) || (__PIC32_FEATURE_SET__ == 470))
        #define mPORTFSetPinsAnalogOut(_outputs)    (TRISFCLR = (unsigned int)(_outputs),\
												ANSELFSET = (unsigned int)(_outputs))
	#define mPORTFSetPinsAnalogIn(_inputs)      (TRISFSET = (unsigned int)(_inputs),\
												ANSELFSET = (unsigned int)(_inputs))
	#define mPORTFSetPinsDigitalOut(_outputs)   (TRISFCLR = (unsigned int)(_outputs),\
												ANSELFCLR = (unsigned int)(_outputs))
	#define mPORTFSetPinsDigitalIn(_inputs)     (TRISFSET = (unsigned int)(_inputs),\
												ANSELFCLR = (unsigned int)(_inputs))
#else
...
#if ((__PIC32_FEATURE_SET__ == 330) || (__PIC32_FEATURE_SET__ == 350) || (__PIC32_FEATURE_SET__ == 370) || (__PIC32_FEATURE_SET__ == 430) || (__PIC32_FEATURE_SET__ == 450) || (__PIC32_FEATURE_SET__ == 470))
        #define mPORTGSetPinsAnalogOut(_outputs)    (TRISGCLR = (unsigned int)(_outputs),\
												ANSELGSET = (unsigned int)(_outputs))
	#define mPORTGSetPinsAnalogIn(_inputs)      (TRISGSET = (unsigned int)(_inputs),\
												ANSELGSET = (unsigned int)(_inputs))
	#define mPORTGSetPinsDigitalOut(_outputs)   (TRISGCLR = (unsigned int)(_outputs),\
												ANSELGCLR = (unsigned int)(_outputs))
	#define mPORTGSetPinsDigitalIn(_inputs)     (TRISGSET = (unsigned int)(_inputs),\
												ANSELGCLR = (unsigned int)(_inputs))
#else
